...
Get-Content -Path C:\Users\nicholas.rubera\Desktop\test\sample.txt | `
...
Get-FileHash C:\Users\nicholas.rubera\Desktop\test\*.csv | `
Export-Csv -Path C:\Users\nicholas.rubera\Desktop\test\FileHashes\hash.csv

}

# Calling function and compressing files into a zip file
tool_kit 
Compress-Archive -Path C:\Users\nicholas.rubera\Desktop\test -DestinationPath C:\Users\nicholas.rubera\Desktop\results.zip
